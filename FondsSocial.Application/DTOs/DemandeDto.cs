...
namespace FondsSocial.Application.DTOs
{
    public class DemandeDto
    {
        ...
        public IEnumerable<HistoriqueStatutDemandeDto>? HistoriqueStatuts { get; set; }
        public IEnumerable<PieceJustificativeDto>? PieceJustificatives { get; set; }
        public IEnumerable<DecisionDto>? Decisions { get; set; }
    }
}
